...
if __name__ == '__main__':
    ...
    X_train_text = train_data[text_feature_name]
    X_test_text = test_data[text_feature_name]
    X_train = pd.merge(X_train_fe,X_train_text,left_index=True,right_index=True)
    X_test = pd.merge(X_test_fe,X_test_text,left_index=True,right_index=True)
    pipeline = Pipeline([
